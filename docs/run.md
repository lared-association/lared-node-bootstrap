...
* [`lared-node-bootstrap run`](#lared-node-bootstrap-run)
...
_See code: [src/commands/run.ts](https://github.com/lared-association/lared-node-bootstrap/blob/v1.1.5/src/commands/run.ts)_
